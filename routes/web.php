...
Route::get('pedido-itens/{id}', PedidoItem::class)->middleware(['auth', 'verified'])->name('pedido-itens');
Route::get('impressao', Impression::class)->middleware(['auth', 'verified'])->name('impressao');
